...
<?php if (get_field('main_slider_slides', 'options')) : ?>
<div class="hero">
    ...
    <div class="pos-r hero-slider-container">
        ...
        <div class="swiper-wrapper">
            <!-- Slides -->
			<?php foreach(get_field('main_slider_slides', 'options') as $slide) : ?>
            <div class="swiper-slide">
                <div class="hero-slider-item">
                    <div class="img">
						<?php echo wp_get_attachment_image( $slide['main_slider_slide_image'], 'full'); ?>
                    </div>
...
<?php if (get_field('is_models_slider', 'options')) : ?>
<?php 
    $models = new WP_Query([
        'post_type' => 'models',
        'post_parent' => 0
...
<section class="models section pt-80 pb-80">
    <div class="overflow-fix-y">
        <div class="container-fluid">
			...
			<?php if (get_field('is_models_slider_filter', 'options')) : ?>
            <div class="row">
                <div class="col-lg-12">
...
<?php if (get_field('is_online_services', 'options')) : ?>
...
<?php if (get_field('is_available_cars', 'options')) : ?>
<?php 
                ...
                <div class="dalacode-selector mb-8" data-container="available-models-slider">
                    ...
                    <div class="options">
                        <ul>
                            ...
                            ?>
                            <?php if (!in_array($terms[0]->name, $models)) :
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide d-flex flex-column justify-content-between model model-wide" data-option="<?= $terms[0]->slug ?>">
                    <div class="top">
                        ...
                        <?php if (get_field('short_description', $car->ID)) : ?>
                        <div class="description">
                            <?= get_field('short_description', $car->ID) ?>
                        </div>
                        <?php endif; ?>
                        <?php if (get_field('price', $car->ID)) : ?>
                        <div class="price mt-2">
                            <?= get_field('price', $car->ID) ?> ₸ <span class="price-sm"><?= price_for_month('price', $car->ID, 36) ?> ₸/мес.</span>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="col-lg-12"> 
                ...
                <div class="pos-r dalacode-slider">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        ?>
                        <?php foreach ($offers_cars->posts as $offer) : ?>
            ...
            <div class="col-lg-12"> 
                ...
                <div class="pos-r dalacode-slider">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        ?>
                        <?php foreach ($offers_service->posts as $offer) : ?>
                        <div class="swiper-slide d-flex flex-column justify-content-between model">
                            <div class="offers-card">
                                <div class="img">
                                    <a href="<?= get_the_permalink( $offer->ID ) ?>">
            ...
            <div class="col-lg-12"> 
                ...
                <div class="pos-r dalacode-slider">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        ?>
                        <?php foreach ($company_news->posts as $post) : ?>
                        <div class="swiper-slide d-flex flex-column justify-content-between model">
                            <div class="offers-card">
                                <div class="img">
