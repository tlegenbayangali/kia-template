            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="equip-hero-inner">
                        ...
                        <span class="val">
                            <?php
                            the_field('starting_price', $parent_post_id); ?> ₸
                        </span>
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $engine = get_field('common_chars', $post->ID)[ 'engine' ]; ?>
                                                                <!-- SWIPER ITEMS START-->
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $power = get_field('common_chars', $post->ID)[ 'power' ]; ?>
                                                                <!-- SWIPER ITEMS START-->
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $rotate_moment = get_field('common_chars', $post->ID)[ 'rotate_moment' ]; ?>
                                                                <!-- SWIPER ITEMS START-->
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $engine_type = get_field('common_chars', $post->ID)[ 'engine_type' ]; ?>
                                                                <!-- SWIPER ITEMS START-->
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $transmission = get_field('common_chars', $post->ID)[ 'transmission' ]; ?>
                                                                <!-- SWIPER ITEMS START-->
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $drive_wheels = get_field('common_chars', $post->ID)[ 'drive_wheels' ]; ?>
                                                                <!-- SWIPER ITEMS START-->
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $zero_hundred = get_field('common_chars', $post->ID)[ 'zero_hundred' ]; ?>
                                                                <!-- SWIPER ITEMS START-->
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $consumption = get_field('common_chars', $post->ID)[ 'consumption' ]; ?>
                                                                <!-- SWIPER ITEMS START-->
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $co2_city = get_field('co2_city', $post->ID); ?>
                                                                <!-- SWIPER ITEMS START-->
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $co2_track = get_field('co2_track', $post->ID); ?>
                                                                <!-- SWIPER ITEMS START-->
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $co2_combine = get_field('co2_combine', $post->ID); ?>
                                                                <!-- SWIPER ITEMS START-->
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $model_code = get_field('model_code', $post->ID); ?>
                                                                <!-- SWIPER ITEMS START-->
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $model_year = get_field('model_year', $post->ID); ?>
                                                                <!-- SWIPER ITEMS START-->
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $elektrooborudovanie = get_field('elektrooborudovanie', $post->ID); ?>
                                                                <?php
                                                                // echo '<pre>';
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($elektrooborudovanie[ 'akkumulyator_amper-chasov' ]) : ?>
                                                        ...
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($elektrooborudovanie[ 'generator' ]) : ?>
                                                        ...
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($elektrooborudovanie[ 'starter' ]) : ?>
                                                        ...
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($elektrooborudovanie[ 'obem_masla_v_dvigatele_l' ]) : ?>
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $dinamicheskie_harakteristiki = get_field('dinamicheskie_harakteristiki', $post->ID); ?>
                                                                <!-- SWIPER ITEMS START-->
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($dinamicheskie_harakteristiki[ 'maksimalnaya_skorost_kmch' ]) : ?>
                                                        ...
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($dinamicheskie_harakteristiki[ 'uskorenie_sek_0-100_kmch' ]) : ?>
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $vnutrennie_razmery = get_field('vnutrennie_razmery', $post->ID); ?>
                                                                <?php
                                                                // echo '<pre>';
                                                                // print_r($elektrooborudovanie);
                                                                // echo '</pre>';
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($vnutrennie_razmery[ 'obem_bagazhnogo_otdeleniya_l' ]) : ?>
                                                        ...
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($vnutrennie_razmery[ 'obem_bagazhnogo_otdeleniya_l_pri_slozhennyh_zadnih_sidenyah' ]) : ?>
                                                        ...
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($vnutrennie_razmery[ 'razmery_pogruzochnogo_prostranstva_mm_za_2ym_ryadom_sidenij_dlinashirinavysota' ]) : ?>
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $massa_5_mest = get_field('massa_5_mest', $post->ID); ?>
                                                                <?php
                                                                // echo '<pre>';
                                                                // print_r($elektrooborudovanie);
                                                                // echo '</pre>';
                                                        ...
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($massa_5_mest[ 'polnaya_massa_kg' ]) : ?>
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $podveska = get_field('podveska', $post->ID); ?>
                                                                <?php
                                                                // echo '<pre>';
                                                                // print_r($elektrooborudovanie);
                                                                // echo '</pre>';
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $tormoza = get_field('tormoza', $post->ID); ?>
                                                                <?php
                                                                // echo '<pre>';
                                                                // print_r($elektrooborudovanie);
                                                                // echo '</pre>';
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($tormoza[ 'razmer_perednih_tormoznyh_diskov' ]) : ?>
                                                        ...
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($tormoza[ 'razmer_zadnih_tormoznyh_diskov' ]) : ?>
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $rulevoe_upravlenie = get_field('rulevoe_upravlenie', $post->ID); ?>
                                                                <?php
                                                                // echo '<pre>';
                                                                // print_r($elektrooborudovanie);
                                                                // echo '</pre>';
                                                        ...
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($rulevoe_upravlenie[ 'chislo_oborotov_rulya_mezhdu_krajnimi_polozheniyami' ]) : ?>
                                                        ...
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($rulevoe_upravlenie[ 'minimalnyj_radius_razvorota_m' ]) : ?>
                                                        ...
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($rulevoe_upravlenie[ 'peredatochnoe_chislo_rulevogo_upravleniya' ]) : ?>
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $transmissiya = get_field('transmissiya', $post->ID); ?>
                                                                <?php
                                                                // echo '<pre>';
                                                                // print_r($elektrooborudovanie);
                                                                // echo '</pre>';
                                                        ...
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($transmissiya[ 'tip_sczepleniya' ]) : ?>
                                                        ...
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($transmissiya[ 'obem_masla_v_transmissii_l' ]) : ?>
                                                ...
                                                <div class="equip-config-section-item-carousel">
                                                    ...
                                                    <div class="swiper-container equip-config-section-item-carousel-container">
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                <?php
                                                                $dvigatel_2 = get_field('dvigatel_2', $post->ID); ?>
                                                                <?php
                                                                // echo '<pre>';
                                                                // print_r($elektrooborudovanie);
                                                                // echo '</pre>';
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($dvigatel_2[ 'rabochij_obem_sm3' ]) : ?>
                                                        ...
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($dvigatel_2[ 'diametr_czilindra_h_hod_porshnya_mm' ]) : ?>
                                                        ...
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($dvigatel_2[ 'maks_moshhnost_ls_obmin' ]) : ?>
                                                        ...
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($dvigatel_2[ 'maks_krutyashhij_moment_nm_obmin' ]) : ?>
                                                        ...
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($dvigatel_2[ 'kolichestvo_czilindrov' ]) : ?>
                                                        ...
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($dvigatel_2[ 'toplivnaya_sistema' ]) : ?>
                                                        ...
                                                        <div class="swiper-wrapper equip-config-section-item-carousel-wrapper">
                                                            ...
                                                            foreach ($configs->posts as $post) : ?>
                                                                ...
                                                                <div class="swiper-slide equip-config-section-item-carousel-slide">
                                                                    <div>
                                                                        <?php
                                                                        if ($dvigatel_2[ 'obem_toplivnogo_baka_l' ]) : ?>
