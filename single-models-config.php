        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="steps-wrapper">
                    <div class="steps-item <?php if ($current_step == 1) : echo 'current';
                                            else : echo 'done';
                                            endif; ?>">
                    ...
                    <div class="steps-item <?php if ($current_step == 2) : echo 'current';
                                            elseif ($current_step < 2) : echo '';
                                            else : echo 'done';
                                            endif; ?>">
                        <div class="steps-item-number">
                            02
                    ...
                    <div class="steps-item <?php if ($current_step == 3) : echo 'current';
                                            elseif ($current_step < 3) : echo '';
                                            else : echo 'done';
                                            endif; ?>"">
                        <div class=" steps-item-number">
                        03
                ...
                <div class="steps-item <?php if ($current_step == 4) : echo 'current';
                                        elseif ($current_step < 4) : echo '';
                                        else : echo 'done';
                                        endif; ?>"">
                        <div class=" steps-item-number">
                    04
            ...
            <div class="steps-item <?php if ($current_step == 5) : echo 'current';
                                    elseif ($current_step < 5) : echo '';
                                    else : echo 'done';
                                    endif; ?>"">
                        <div class=" steps-item-number">
                05
...
<div class="section section-divided pos-r" data-sticky-container>
    <div class="container">
        <div class="row g-0">
            <div class="col-xl-4 col-xxl-3 col-lg-12 pr-40 pb-30 aside bg-lgray <?php if ($current_step == 5) : echo 'd-none';
                                                                                endif; ?>">
            ...
            <div class="<?php if ($current_step == 5) : echo 'col-12';
                        else : echo 'col-xl-8 col-xxl-9 col-lg-12';
                        endif ?>">
