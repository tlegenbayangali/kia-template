 ...
 * version 3.3.2
 */
function kama_breadcrumbs( $sep = null, $l10n = array(), $args = array() ){
...
class Kama_Breadcrumbs {
	...
	function get_crumbs( $sep, $l10n, $args ){
		...
		if(1){
			...
			if( ! $mark ) $mark = array(
				'wrappatt'  => '<ul class="d-inline-flex align-items-center">%s</ul>',
				'linkpatt'  => '<a class="underlined underlined-black" href="%s">%s</a>',
				'sep_after' => '',
			);
			// rdf
			elseif( $mark === 'rdf.data-vocabulary.org' ) $mark = array(
				'wrappatt'   => '<ul class="d-inline-flex align-items-center" prefix="v: http://rdf.data-vocabulary.org/#">%s</ul>',
			...
			elseif( $mark === 'schema.org' ) $mark = array(
				'wrappatt'   => '<ul class="d-inline-flex align-items-center" itemscope itemtype="http://schema.org/BreadcrumbList">%s</ul>',
